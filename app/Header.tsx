      ...
      <div className="flex items-center gap-3">
        {mounted && (
          <button
            ...
            className="text-gray-800 dark:text-gray-50 w-5 h-5 cursor-pointer hover:opacity-70 transition-opacity"
          >
        ...
        <div className="group relative">
          <Globe
            className="text-gray-800 dark:text-gray-50 w-5 h-5 cursor-pointer"
          />
